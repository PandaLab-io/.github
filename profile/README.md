...
> **Innovative. Anonymous. Open Source.**  
> A collective of developers building simple, powerful and open technologies.

---

##  About Us
PandaLab is a small anonymous team of passionate developers and creators.  
We build open-source tools, experimental apps, and design systems — focused on **clarity**, **usability**, and **freedom**.

Our mission is to craft digital experiences that are:
-  **Smart** — clear, minimal, and technically solid  
-  **Kiss & Beautiful** — design-driven: simple and accessible  
-  **Open** — shared with the world through transparent code  

---

## Projects
Here are our main repositories — the core of the PandaLab ecosystem:
...
- **Infra:** GitHub Actions, Docker, Kubernetes, AWS, CI/CD, custom scripts  
- **Design:** Figma  
